...
function takeHeadcountSnapshot() {
  ...
  Object.keys(summary).sort().forEach(divName => {
    ...
    Object.keys(summary[divName].groups).sort().forEach(groupName => {
      processLevel(divName, groupName, '', '', summary[divName].groups[groupName]);
      Object.keys(summary[divName].groups[groupName].departments).sort().forEach(deptName => {
        processLevel(divName, groupName, deptName, '', summary[divName].groups[groupName].departments[deptName]);
        Object.keys(summary[divName].groups[groupName].departments[deptName].sections).sort().forEach(secName => {
